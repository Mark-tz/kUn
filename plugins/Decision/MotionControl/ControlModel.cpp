...
void CControlModel::makeCmTrajectory(const PlayerPoseT& start, const PlayerPoseT& final, const PlayerCapabilityT& capability, double speed_trans_threashold)
{
    _pathList.clear();
    ...
    goto_point_omni(start,final,capability,accel_factor,angle_accel_factor,_nextStep, speed_trans_threashold);
}
