...
void CGDebugEngine::gui_debug_x(const CGeoPoint& p, int debug_color){
	CGeoPoint basePos = p;
...
void CGDebugEngine::gui_debug_points(const std::vector<CGeoPoint> points, int debug_color){
    debugMutex.lock();
...
void CGDebugEngine::gui_debug_line(const CGeoPoint& p1, const CGeoPoint& p2, int debug_color){
    debugMutex.lock();
    Debug_Msg* msg = guiDebugMsgs.add_msgs();
...
void CGDebugEngine::gui_debug_arc(const CGeoPoint& p, double r, double start_angle, double span_angle, int debug_color){
    debugMutex.lock();
    Debug_Msg* msg = guiDebugMsgs.add_msgs();
...
void CGDebugEngine::gui_debug_triangle(const CGeoPoint& p1, const CGeoPoint& p2, const CGeoPoint& p3, int debug_color){
    debugMutex.lock();
    Debug_Msg* msg = guiDebugMsgs.add_msgs();
...
void CGDebugEngine::gui_debug_msg(const CGeoPoint& p, const char* msgstr, int debug_color)
{
    debugMutex.lock();
    Debug_Msg* msg = guiDebugMsgs.add_msgs();
...
void CGDebugEngine::gui_debug_curve(const double num, const double maxLimit, const double minLimit, int debug_color)
{
    debugMutex.lock();
    Debug_Msg* msg = guiDebugMsgs.add_msgs();
