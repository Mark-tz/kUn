...
extern CGeoPoint MakeOutOfCircle(const CGeoPoint& center, const double radius, const CGeoPoint& start, const CGeoPoint& target, const double buffer);
extern CGeoPoint MakeOutOfLongCircle(const CGeoPoint& seg_start, const CGeoPoint& seg_end, const double radius, const CGeoPoint& start, const CGeoPoint& target, const double buffer);
