...
struct PlayerStatus{
    ...
    //Zget专用
    static const int KICK                           = 0x00100000;
    static const int DRIBBLE                        = 0x00200000;
    static const int CHIP                           = 0x00400000;
    static const int SAFE                           = 0x00800000;
	// 处理球的flags
	static const int SPECIFY_DIRECTION				= 0x01000000; // 指定身体朝向
	static const int IGNORE_PLAYER_CLOSE_TO_TARGET	= 0x02000000; // 忽略挡住目标点的队员
	static const int OUR_BALL_PLACEMENT				= 0x04000000; // 自动放球 added by Wayne in 2018/6/6
