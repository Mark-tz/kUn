...
CAdvanceBallV1::CAdvanceBallV1()
{
    ...
    ZSS::ZParamManager::instance()->loadParam(GENTLE_MODE,"JamAndRush/GentleMode",false);
    ZSS::ZParamManager::instance()->loadParam(OPP_HAS_BALL_DIST,"JamAndRush/OppHasBallDist",50);
    ZSS::ZParamManager::instance()->loadParam(CIRCLE_FRONT,"JamAndRush/CircleFront",true);
...
//	bool oppNearLeft = opp2GoalRightDist > opp2GoalLeftDist;
	...
	if (ball.X() < -Param::Field::PITCH_LENGTH/4 && abs(ball.Y()) > Param::Field::PENALTY_AREA_WIDTH / 2 )
