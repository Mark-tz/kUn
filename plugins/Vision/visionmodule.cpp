...
void VisionModule::updateVel(ReceiveVisionMessage& message)
{
...
void VisionModule::updateRobotVel(int team, ReceiveVisionMessage& message) {
...
void VisionModule::updateBallVel(ReceiveVisionMessage & message)
{
	...
	message.ball[0].fill(filtPoint.x(), filtPoint.y(), 0, ballVel);
}

void VisionModule::parseVisionMessage(SSL_WrapperPacket& packet , ReceiveVisionMessage& message)
{
...
void VisionModule::encodeMessage(Vision_DetectionFrame &detectionFrame, ReceiveVisionMessage & message)
{
